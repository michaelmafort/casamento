<div class="presentes index">
	<h2><?php echo __('Presentes'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $presente['Presente']['id']), null, __('Are you sure you want to delete # %s?', $presente['Presente']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
